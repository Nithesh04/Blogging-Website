      ...
      <nav className=" shadow-lg px-4 py-2">
        <div className="flex items-center justify-between container mx-auto">
          <div className="font-semibold text-xl">
            <span className="text-red-500 max-lg:* text-4xl">Blog</span>
          </div>
          {/* Desktop */}
          <div className=" mx-6">
            <ul className="hidden md:flex space-x-6 ">
              ...
              <Link to="/blogs" className="hover:text-blue-500 text-lg">
                BLOGS
              </Link>
              <Link to="/creators" className="hover:text-blue-500 text-lg">
                CREATORS
              </Link>
              <Link to="/about" className="hover:text-blue-500 text-lg">
                ABOUT
              </Link>
              <Link to="/contact" className="hover:text-blue-500 text-lg">
                CONTACT
              </Link>
            </ul>
          ...
          <div className="hidden md:flex space-x-2">
            {isAuthenticated && profile?.user?.role === "admin" ? (
              <Link
                to="/dashboard"
                className="bg-orange-400 text-white font-semibold hover:bg-blue-800 duration-300 px-4 py-2 rounded"
              >
                DASHBOARD
              </Link>
            ) : (
